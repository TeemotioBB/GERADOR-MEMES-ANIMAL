...
Esta edição foi preparada para deixar todos os arquivos na raiz do repositório do GitHub.
Não mova `index.html`, `styles.css`, `app.js`, `sample-dog.jpg` ou `default_prompt.txt` para outras pastas.
